...
import { light as lightThinksy, dark as darkThinksy } from './palette--thinksy';

const palette = (themeMode = 'light', paletteType = 'thinksy') => {
  if (paletteType === 'blue') {
  ...
  } else if (paletteType === 'thinksy') {
    return themeMode === 'dark' ? darkThinksy : lightThinksy;
  }
